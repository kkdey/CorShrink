...
par(mfrow=c(1,2))
out <- CorShrinkData(sample_by_feature_data, sd_boot = FALSE, image_original = TRUE, 
...
par(mfrow=c(1,2))
out <- CorShrinkData(sample_by_feature_data, sd_boot = TRUE, image_original = TRUE, 
                     image_corshrink = TRUE, image.control = list(x.cex = 0.3, y.cex = 0.3))
```
...
out <- CorShrinkMatrix(pairwise_corr_matrix, zscore_sd = zscoreSDmat, image_original = TRUE, image_corshrink = TRUE)
```
...
par(mfrow=c(1,2))
out <- CorShrinkData(sample_by_feature_data, sd_boot = FALSE, image_corshrink = TRUE, 
                     image.control = list(x.cex = 0.3, y.cex = 0.3,
